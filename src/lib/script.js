...
const SV_MAIL = ['ana.rodrigues.iti@gmail.com', 'eldylazaro@colorado.edu', 'economidoue@acm.org', 'e.m.vasconcelos.de.gouveia@tue.nl', 'Hilamor@berkeley.edu', 'hji64@gatech.edu',
    ...
    'maritza.silva@gmail.com', 'toraja@uio.no', 'yliu3494@gatech.edu'];
...
const TEAM_MAIL = ['nunojnunes@tecnico.ulisboa.pt', 'hugo.nicolau@tecnico.ulisboa.pt', 'marianapestana@tecnico.ulisboa.pt', 'mara.dionisio@staff.uma.pt', 'paulo.bala@tecnico.ulisboa.pt',
    ...
    'carine.lallemand@hotmail.fr', 'Ellen.do@colorado.edu', 'msgdionisio@gmail.com', 'imshuhao.ma@gmail.com', 'ian.r.oakley@gmail.com', 'catia.prandi@unibo.it', 'lizette.reitsma@mau.se', 'elise.vandenHoven@uts.edu.au', 'ellen.do@colorado.edu'];
