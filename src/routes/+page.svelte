...
<div class="container">
  <br />
  <a href="/acm-member" class="button"> ACM/SIGCHI Member </a>
  <p>
    For ACM/SIGCHI Members <br />
    Must use the email address associated with your ACM/SIGCHI membership. Emeritus
    Members - please use the Non-Member button.
  </p>

  <a href="/non-member" class="button"> Non-Member </a>
  <p>
    For Non-Members of ACM - For Emeritus Members Become an ACM Member today,
    then register as an ACM/SIGCHI member! https://www.acm.org/membership <br />
    Enjoy many benefits of being an ACM member, including a discount on CHI 2025
    registration
  </p>
</div>
